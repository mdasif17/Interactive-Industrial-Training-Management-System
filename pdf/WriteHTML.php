...
class PDF_HTML extends FPDF {
      ...
      $w=array();
        ...
        if ($start !== false && $end !== false) {
            ...
            for ($i = 1; $i <= count($tableData[0]); $i++) {
                if ($i == 1)
                    $w[] = abs(80 / (count($tableData[0]) - 1)) - 30;
                else if ($this->CurOrientation == 'L')
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 24;  //80 => 120
                else
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 40;  //80 => 120
            }
    ...
    function WriteHTML5($html) {
        ...
        if ($start !== false && $end !== false) {
            ...
            for ($i = 1; $i <= count($tableData[0]); $i++) {
                if ($i == 1)
                    $w[] = abs(80 / (count($tableData[0]) - 1)) ;
               else  if ($i == 2)
                    $w[] = abs(80 / (count($tableData[0]) - 1)) +50;
                else if ($i == 3 || $i == 4)
                    $w[] = abs(80 / (count($tableData[0]) - 1)) +8;
                else if ($this->CurOrientation == 'L')
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 24;  //80 => 120
                else
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 40;  //80 => 120
    ...
    function WriteHTML6($html) {
      $w=array();
        ...
        if ($start !== false && $end !== false) {
            ...
            for ($i = 1; $i <= count($tableData[0]); $i++) {
                if ($i == 1)
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 40;
                else if ($this->CurOrientation == 'L')
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 24;  //80 => 120
                else
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 6;  //80 => 120
            }
            $this->WriteTable($tableData, $w);
        ...
        if ($start !== false && $end !== false) {
            ...
            for ($i = 1; $i <= count($tableData[0]); $i++) {
                if ($i == 1)
                    ...
                    $w[] = abs(80 / (count($tableData[0]) - 1)) + 10;  //80 => 120
                else
