...
$sql = "SELECT * FROM overall_evaluation where student_id='".$_POST['student_id']."'";
$company = mysql_query("SELECT * FROM company_registration WHERE student_id='".$_POST['student_id']."'");
$company_row = mysql_fetch_array($company);
...
$pdf->WriteHTML('<h4>Company Attached:   '.$company_row['company_name'].'</h4><br><br>');
$status="";
